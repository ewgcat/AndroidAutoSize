    ...
    companion object {
        ...
        fun autoConvertDensityOfGlobal(resources: Resources) {
            if (AutoSizeConfig.instance!!.isBaseOnWidth) {
                autoConvertDensityBaseOnWidth(resources, AutoSizeConfig.instance!!.designWidthInDp.toFloat())
            } else {
                autoConvertDensityBaseOnHeight(resources, AutoSizeConfig.instance!!.designHeightInDp.toFloat())
            }
        }
         ...
         */
        fun autoConvertDensityOfCustomAdapt(resources: Resources, customAdapter: CustomAdapter) {
            ...
            autoConvertDensity(resources, sizeInDp, customAdapter.isBaseOnWidth)
        }
        ...
        fun cancelAdapt(resources: Resources) {
            ...
            setDensity(resources, AutoSizeConfig.instance!!.initDensity, AutoSizeConfig.instance!!.initDensityDpi, AutoSizeConfig.instance!!.initScaledDensity, initXdpi)
            setScreenSizeDp(resources, AutoSizeConfig.instance!!.initScreenWidthDp, AutoSizeConfig.instance!!.initScreenHeightDp)
        }
